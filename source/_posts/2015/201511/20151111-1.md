...
5. 报错排错：
![apache_error](http://resoure.uiste.com/1apache_error.png)
```		
...
7. 安装MySQL
		...
		2. 成功提示：
![Alt text](http://resoure.uiste.com/2.mysql_success.png)
8. 再次修改权限
...
14. 打开MySQL客户端
		...
		2. `Enter password:`
15. 报错排错
![Alt text](http://resoure.uiste.com/3.mysql_error1.png)
![Alt text](http://resoure.uiste.com/4.mysql_error2.png)
![Alt text](http://resoure.uiste.com/5.mysql_error3.png)
#### 设置远程登录权限
1. `mysql> use mysql`
2. `mysql> select host,user from user;`
![Alt text](http://resoure.uiste.com/6.quanxian1.png)
3. `mysql> update user set host='%' where user ='root' and host ='127.0.0.1';`
![Alt text](http://resoure.uiste.com/7.quanxian2.png)
4. `mysql> delete from user where host != '%';`
![Alt text](http://resoure.uiste.com/8.quanxian3.png)
